const CONFIG = {
    ...
    desc: 'Anh vẫn muốn quỳ gối trước nàng công chúa, đẹp nhất đêm nay 🥺',
    btnYes: 'Gkee zậy sao',
    btnNo: 'Xàm quá :)))',
    question: 'Anh có câu hỏi là: liệu chúng ta có thể bắt đầu một mối quan hệ mới, như là người yêu chẳng hạn? :v',
    btnReply: 'Gửi ở đây nè!',
    reply: 'ỏhhh, đáng iu quá zị nè 😻 ',
